...
%
In the first case~\cite{DBLP:journals/taas/FarabegoliDAV2025}, we applied this approach to optimize task allocation in 
 the edge-cloud continuum, demonstrating how agents executing a macro-program composed of multiple submodules can offload 
 some of these submodules to an edge or cloud server to meet latency and battery constraints. 
%
