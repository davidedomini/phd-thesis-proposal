...
% - our latest works, builds on top of the concept of creating subregions explained above but extends this with the concept of space-fluidity
% - more specifically subregions are no more created considering only the spatial proximity but also including some similarity metrics to shrink or expand them if needed
% - More in detail  
...
% show that sac paper is usefull also with localized phenomena
